...
const Hero = () => {
  return (
    <div className="ralative h-screen flex flex-center justify-center text-white overflow-hidden flex-col">
      <ParticlesHero />
      <div className="relative z-10 flex flex-col items-center ">
        <Image
          src="/images/samim.jpg"
          alt="hero image"
          width={150}
          height={150}
          className="rounded-full border-8 border-[#0c0c48aa] text-gray-800"
          data-aos="fade-up"
        />
        <h1
          data-aos="fade-up"
